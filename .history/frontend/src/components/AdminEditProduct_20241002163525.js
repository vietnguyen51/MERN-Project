  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (responseData.success) {
        ...
        // Kiểm tra xem fetchData có phải là một hàm không trước khi gọi
        if (typeof fetchData === "function") {
          fetchData(); // Gọi hàm fetchData để làm mới dữ liệu
        } else {
          console.warn("fetchData is not provided or is not a function");
        }
      } else {
