    ...
    <header className="bg-black text-white relative">
      <div className="container mx-auto px-4 py-4">
        <div className="flex justify-between items-center">
          ...
          <nav className={`hidden lg:flex space-x-6 ${isMenuOpen ? 'block' : ''}`}>
            <Link to="/women" className="hover:underline text-sm tracking-wide">WOMEN</Link>
            <Link to="/men" className="hover:underline text-sm tracking-wide">MEN</Link>
            <Link to="/collections" className="hover:underline text-sm tracking-wide">COLLECTIONS</Link>
            <Link to="/gifts" className="hover:underline text-sm tracking-wide">GIFTS</Link>
          </nav>
