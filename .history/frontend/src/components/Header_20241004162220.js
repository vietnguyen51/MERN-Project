  ...
  return (
    <header className="bg-black text-white relative">
      <div className="container mx-auto px-4 py-4">
        ...
        {isMenuOpen && (
          <nav className="fixed inset-0 bg-ivory bg-slate-50 text-black z-50 lg:hidden">
            {" "}
            {/* Toàn bộ màn hình với màu nền trắng ngà */}
            <div className="container mx-auto px-4 py-8">
              ...
              >
                <X size={24} /> {/* Nút đóng menu */}
              </button>
              <div className="flex flex-col space-y-6 mt-12 text-center">
                {" "}
                {/* Dùng space-y-6 để tạo khoảng cách giữa các mục */}
